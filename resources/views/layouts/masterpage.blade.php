...
<head>
    <title>{{ config('app.name', 'NOUN HR-PLUS') }} | {{isset($pageName) ? $pageName : ""}}</title>
    ...
    <section class="vbox">
        <header class="bg-primary dker lter header navbar navbar-fixed-top-xs">
            <div class="navbar-header aside-md">
                ...
                <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="{{asset('incs/hr_logo.png')}}" class="m-r-lg">HR PLUS</a>
