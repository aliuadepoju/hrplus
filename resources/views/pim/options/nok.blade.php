  <div class="col-lg-12">
    <div class="panel">
        <div class="panel-heading">
            <h5 class="panel-title">{{$person->surname}}'s Next of Kin</h5>
        </div>
        <div class="panel-body">
        
           <form action="{{url('/pim/employees/data/nok_update/'.\Crypt::encrypt(5))}}" method="post" role="form">
           {{csrf_field()}}
           <input type="hidden" name="personnel_id" value="{{$person->id}}">
           <input type="hidden" name="nok_id" value="{{isset($person->getNOK) ? $person->getNOK->id : 'NA'}}">
          <div class="col-md-12">
            <div class="row">
              <div class="form-group col-md-4">
                  <label for="">Full Names</label>
                  <input type="text" name="nok_name" class="form-control" value="{{isset($person->getNOK) ? $person->getNOK->full_names : 'NA'}}">    
              </div>

              <div class="form-group col-md-3">
                  <label for="">Phone No </label>
                  <input type="text" name="nok_phone" class="form-control" value="{{isset($person->getNOK) ? $person->getNOK->phone_no : 'NA'}}">    
              </div>
              ...
              <div class="form-group col-md-3">
                  ...
                  <div class="" id="nok_other">
                      ...
                      <input type="text" name="nok_other_name" class="form-control" value="{{isset($person->getNOK) ? $person->getNOK->relation_other_name : 'NA'}}" >    
                  </div>
              </div>
          ...
          <div class="row">
              ...
              <div class="form-group col-md-3">
                  ...
                  <input type="text" class="form-control" name="nok_street_name_no" value="{{isset($person->getNOK) ? $person->getNOK->street_name : 'NA'}}">
              </div>
              <div class="form-group col-md-3">
              ...
              <div class="form-group col-md-12">
                  ...
                  <input type="text" name="nok_locality" class="form-control" value="{{isset($person->getNOK) ? $person->getNOK->town: 'NA'}}">    
              </div>
          </div>
