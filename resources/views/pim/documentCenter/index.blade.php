                        ...
                        <section class="panel panel-default">
                           ...
                           @endif
                                <div class="clearfix">
                                    ...
                                    <div class="clear">
                                        <div class="h4 m-t-xs m-b-xs text-white"><a href="{{url('/pim/employees/data/'.$person->id)}}">{{$person->title .' '.$person->surname.' '. $person->middle_name .' '.$person->first_name }} <i class="fa fa-eye text-white pull-right text-xs m-t-sm"> </i></a>  </div> <small class="text-muted">{{$person->getNOUNInfos->rank}}</small> </div>
                                </div>
                            </header></a>
