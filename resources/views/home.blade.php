                                ...
                                <div class="carousel-inner">
                                        ...
                                        <div class="row">
                                           <div class="col-md-6 text-center" >
                                                <div class="col-sm-12 col-md-12 padder-v b-r b-light"> <span class="fa-stack fa-2x pull-left m-r-sm"> <i class="fa fa-circle fa-stack-2x text-info"></i> <i class="fa fa-male fa-stack-1x text-white"></i> </span>
                                                    ...
                                                    {{number_format($seniorStaff->count())}}
                                                    </strong></span> <small class="text-muted text-uc">Senior Staff</small> </a>
                                                </div>
                                           </div>
                                           <div class="col-md-6 text-center">
                                               <div class="col-sm-12 col-md-12 padder-v b-r b-light"> <span class="fa-stack fa-2x pull-left m-r-sm"> <i class="fa fa-circle fa-stack-2x text-info"></i> <i class="fa fa-male fa-stack-1x text-white"></i> </span>
                                                    <a class="clear" href="#"> <span class="h3 block m-t-xs"><strong>{{number_format($juniorStaff->count())}}</strong></span> <small class="text-muted text-uc">Junior Staff</small> </a>
                                                </div>
                                           </div>
                                       </div>
                                    </div>
                                    <div class="item">
                                        <div class="row">
                                           <div class="col-md-6 text-center" >
                                                <div class="col-sm-12 col-md-12 padder-v b-r b-light"> <span class="fa-stack fa-2x pull-left m-r-sm"> <i class="fa fa-circle fa-stack-2x text-info"></i> <i class="fa fa-male fa-stack-1x text-white"></i> </span>
                                                    <a class="clear" href="#"> <span class="h3 block m-t-xs"><strong>{{number_format($fullTimeStaff->count())}}</strong></span> <small class="text-muted text-uc">Full Time Employment</small> </a>
                                                </div>
                                           </div>
                                           <div class="col-md-6 text-center">
                                               <div class="col-sm-12 col-md-12 padder-v b-r b-light"> <span class="fa-stack fa-2x pull-left m-r-sm"> <i class="fa fa-circle fa-stack-2x text-info"></i> <i class="fa fa-male fa-stack-1x text-white"></i> </span>
                                                    <a class="clear" href="#"> <span class="h3 block m-t-xs"><strong>{{number_format($transientStaff->count())}}</strong></span> <small class="text-muted text-uc">Transient Staff</small> </a>
                                                </div>
                                           </div>
                                       </div>
                                    </div>
