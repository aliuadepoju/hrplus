<div class="col-lg-12">
    <div class="panel">
        <div class="panel-heading">
            <h5 class="panel-title" align="center"> DEACTIVATING {{$branch->branch_name}}</h5>
        </div>
        <div class="panel-body">
            <form action="{{url('/branches/data/deactivate/'.$branch->id)}}" method="POST" role="form" class="form">
            {{csrf_field()}}
                <input type="hidden" class="form-control" id="branchId" name="branchId" value="{{$branch->id}}">
