                ...
                <div class="table-responsive">
                    <table class="table table m-b-none" data-ride="datatables" id="datatables">
                        ...
                        @foreach($salCats as $cat)
                            <tr>
                                <td>{{$sn}}</td>
                                <td><a href="{{url('/system/salary-structures/categories/data/'.\Crypt::encrypt($cat->id))}}" class="link"> {{$cat->code}}</a></td>
                                <td><a href="{{url('/system/salary-structures/categories/data/'.\Crypt::encrypt($cat->id))}}" class="link"> {{$cat->category_name}}</a></td>
