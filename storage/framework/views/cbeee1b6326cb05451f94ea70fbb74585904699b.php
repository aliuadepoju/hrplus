...
<section id="content">
        <div class="row m-n">
            ...
            <div class="col-sm-4 col-md-8 col-md-offset-0">
                ...
                <br>
                    <h1 class="h text-warning animated fadeInDownBig"> <img src="<?php echo e(asset('incs/images/hr_logobig.png')); ?>" class="" style="height: 180px;"> OPS!</h1> 
                </div>
                ...
                <div class="list-group m-b-sm bg-white m-b-lg">
                    <a href="<?php echo e(url('/home')); ?>" class="list-group-item"> <i class="fa fa-chevron-right icon-muted"></i> <i class="fa fa-fw fa-home icon-muted"></i> Goto homepage </a>
                    ...
                    <a href="<?php echo e(url('system/ticket/new')); ?>" class="list-group-item"> <i class="fa fa-chevron-right icon-muted"></i> <span class="badge"></span> <i class="fa fa-fw fa-question icon-muted"></i> Create a ticket </a>
                    <a href="<?php echo e(url('/')); ?>" class="list-group-item"> <i class="fa fa-chevron-right icon-muted"></i> <span class="badge"></span> <i class="fa fa-fw fa-reply icon-muted"></i> Go back to previous page </a>
                </div>
            </div>
