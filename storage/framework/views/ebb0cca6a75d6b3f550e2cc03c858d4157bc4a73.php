<div class="col-md-12">
	<section class="panel">
        ...
        <div class="panel-body">
            ...
            <h4 align="justify">Are you sure you want to delete <strong><?php echo e($role->name); ?></strong> from the system roles. Hence you are been warned. This action is not revocable and it is logged against your user account. Do you want to proceed with this operation? </h4>
