<div class="col-lg-12">
    <div class="panel">
        <div class="panel-heading">
            <h5 class="panel-title" align="center"> DEACTIVATING <?php echo e($unit->unit_name); ?></h5>
        </div>
        <div class="panel-body">
            <form action="<?php echo e(url('/branches/data/deactivate/'.$unit->id)); ?>" method="POST" role="form" class="form">
            <?php echo e(csrf_field()); ?>

                <input type="hidden" class="form-control" id="unitId" name="unitId" value="<?php echo e($unit->id); ?>">
                ...
                <div class="form-group col-lg-12" align="center">
                    <a href="<?php echo e(url('/branches/departments/units/'.$unit->id)); ?>" class="btn btn-danger">Cancel</a>
