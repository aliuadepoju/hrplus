  <div class="col-lg-12">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h5 class="panel-title">Editing <?php echo e($person->surname); ?>'s Data</h5>
        </div>
        <div class="panel-body">
           <form action="<?php echo e(url('/pim/employees/data/editData')); ?>" method="post" role="form">
          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="form-group col-md-3">
                  ...
                  <input type="text" name="surname" class="form-control" placeholder="Surname" data-required="true" value="<?php echo e($person->surname); ?>">    
              </div>
              <div class="form-group col-md-4">
                  <label for="">First Name</label>
                  <input type="text" name="first_name" class="form-control" placeholder="First Name" data-required="true" value="<?php echo e($person->first_name); ?>">    
              </div>

              <div class="form-group col-md-3">
                  <label for="">Middle Name <small>Optional</small></label>
                  <input type="text" name="middle_name" class="form-control" placeholder="Initials" value="<?php echo e($person->middle_name); ?>">    
              </div>
          </div>
          ...
          <div class="row">
              <div class="form-group col-md-4">
                  ...
                  <input type="text" name="phone" class="form-control" placeholder="08012345678" data-required="true" pattern="(0)([7,8,9])([0,1])(\d{8})" value="<?php echo e($person->phone_no); ?>">    
              </div>

              <div class="form-group col-md-4">
                  <label for="">Alternate Phone Number </label>
                  <input type="text" name="altPhone" class="form-control" placeholder="09-9658525" value="<?php echo e($person->alternate_phone_no); ?>">    
              </div>

              <div class="form-group col-md-4">
                  <label for="">e-Mail</label>
                  <input type="email" name="email" class="form-control" placeholder="you@noun.edu.ng" data-required="true" value="<?php echo e($person->email); ?>">    
              </div>
            ...
            <div class="row">
              <div class="form-group col-md-4">
                  ...
                  <select id="state" style="width:100%;" name="state" required="" class="form-control">
                      <option value="<?php echo e($person->getState->id); ?>" selected=""><?php echo e($person->getState->state); ?></option>
              ...
              <div class="form-group col-md-5">
                  ...
                  <input type="text" name="homeTown" class="form-control" placeholder="Gwagwalada" value="<?php echo e($person->home_town); ?>">    
              </div>
            </div>
            <div class="row">
              ...
              <div class="form-group col-md-4">
                  ...
                  <input name="dob" class="input-s datepicker-input form-control" size="16" type="text" value="<?php echo e($person->dob); ?>" data-date-format="dd-mm-yyyy" style="width:100%;" required="">    
              </div>
            </div>
