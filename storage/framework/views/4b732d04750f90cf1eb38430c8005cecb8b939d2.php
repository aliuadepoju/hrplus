	                ...
	                <table class="table m-b-none" data-ride="datatables" >
	                    ...
	                    <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
	                    	<tr>
	                    		...
	                    		<td><a href="<?php echo e(url('/system/tickets/view/'.\Crypt::encrypt($ticket->id))); ?>" class="link">NOUN-HRPLUS/TCKT/<?php echo e($ticket->serial); ?></a></td>
	                    		<td><a href="<?php echo e(url('/system/tickets/view/'.$ticket->id)); ?>" class="link"> <?php echo e($ticket->title); ?></a></td>
