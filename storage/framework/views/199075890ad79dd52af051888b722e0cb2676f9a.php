...
<body class="">
    ...
    <!-- Easy Pie Chart --> 
    <script src="<?php echo e(asset('incs/js/charts/easypiechart/jquery.easy-pie-chart.js')); ?>"></script> 
    <!-- Flot --> 
   <!--  <script src="<?php echo e(asset('incs/js/charts/flot/jquery.flot.min.js')); ?>"></script> 
    <script src="<?php echo e(asset('incs/js/charts/flot/jquery.flot.tooltip.min.js')); ?>"></script> 
    <script src="<?php echo e(asset('incs/js/charts/flot/jquery.flot.resize.js')); ?>"></script> 
    <script src="<?php echo e(asset('incs/js/charts/flot/jquery.flot.orderBars.js')); ?>"></script> 
    <script src="<?php echo e(asset('incs/js/charts/flot/jquery.flot.pie.min.js')); ?>"></script> 
    <script src="<?php echo e(asset('incs/js/charts/flot/jquery.flot.grow.js')); ?>"></script> 
    <script src="<?php echo e(asset('incs/js/charts/flot/demo.js')); ?>"></script> -->
    ...
    <script src="<?php echo e(asset('incs/js/flot-chart/jquery.flot.pie.js')); ?>"></script>
    <script src="<?php echo e(asset('incs/js/flot-chart/jquery.flot.tooltip.js')); ?>"></script>
    <script src="<?php echo e(asset('incs/js/flot-chart/jquery.flot.resize.js')); ?>"></script>
    <script src="<?php echo e(asset('incs/js/flot-chart/jquery.flot.fillbetween.js')); ?>"></script>
